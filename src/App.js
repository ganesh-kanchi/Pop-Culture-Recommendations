...
const recDataBase = {
  ...
  Series: [
    ...
    },
    {
      name: "Sex Education",
      rating: "4/5",
      link: "https://www.netflix.com/watch/80197526?source=35"
    },
    {
...
export default function App() {
  const [selectedType, setType] = useState("T.V Shows");
  ...
  return (
    <div className="App">
      ...
      >
        {" "}
        Checkout my favorite recommendations. Select The Type of content you
        want to watch to get started{" "}
      </p>

      <div>
        {Object.keys(recDataBase).map((type) => (
          <button
      ...
      <div style={{ textAlign: "left" }}>
        <ul style={{ paddingInlineStart: "0" }}>
          {recDataBase[selectedType].map((rec) => (
            ...
            >
              {" "}
              <a href={rec.link} class="redirecter" target="_blank">
                <div style={{ fontSize: "larger" }}> {rec.name} </div>
              </a>
              <div style={{ fontSize: "smaller" }}> {rec.rating} </div>
            </li>
          ))}
        </ul>
      </div>
      <footer id="foot">
        <h4 id="footer-head"> &#169; | 2021 | Ganesh Kanchi </h4>
        <hr
          style={{
            width: "200px",
            height: "2px",
        ...
        <ul id="footer-ul">
          <li class="footer-li">
            <a
              href="https://github.com/Ganeshkanchimad"
              class="change-color-svg"
            >
              <svg
          ...
          <li class="footer-li">
            <a
              href="https://www.linkedin.com/in/ganesh-kanchi-b9bb7a207/"
              class="change-color-svg"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li class="footer-li">
            <a
              href="https://www.instagram.com/ganesh_aos/"
              class="change-color-svg"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
